...
export const productColumns: ColumnDef<IProduct>[] = [
  {
    ...
    cell: ({ row }) => {
      ...
      const imageUrl = typeof firstImage === "string" ? firstImage : firstImage.secure_url;
      return (
        <div className="w-20 h-20 relative">
          <Image src={imageUrl} alt={row.original.name} fill className="object-cover rounded" fill />
        </div>
      );
    },
  },
